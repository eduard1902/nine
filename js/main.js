...
let buttonPlusIncome = document.getElementsByTagName('button');                 //plus_top 
console.log(buttonPlusIncome);

let buttonPlusExpenses = document.getElementsByTagName('button');               //plus_buttom
...
let additionalInputncome1 = document.querySelectorAll('.additional_income-item'); //Возможный доход
console.log(additionalInputncome1);

let additionalInputncome2 = document.querySelectorAll('.additional_income-item'); //Возможный доход
console.log(additionalInputncome2);

let expensesTitle = document.querySelectorAll('.expenses-title');               // Обязательные расходы
console.log(expensesTitle);

let expensesAmount = document.querySelectorAll('.expenses-amount');             // Обязательные расходы - сумма
console.log(expensesAmount);

let additionalExpensesItem = document.querySelectorAll('.additional_expenses-item'); //Возможные расходы 
console.log(additionalExpensesItem);

let targetAmount = document.querySelectorAll('.target-amount');                     // Цель
console.log(targetAmount);

let periodSelect = document.querySelectorAll('.period-select');                     // Период расчета
console.log(periodSelect);

let resultTotal = document.querySelectorAll('.result-total');                        // Доход за месяц
